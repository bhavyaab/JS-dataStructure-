...
var checkUniqueCharecters = function(str){
  ...
  for(var i = 0; i < str.length/2; i++){
    ...
    var ind1 = newStr1.indexOf(char1); // check if coppied charector is found in the remaining string.
    var ind2 = newStr2.indexOf(char2);  // check if coppied charector is found in the remaining string.
    if(ind1 !== -1 || ind2 !== -1){  // if any of the charector index is not equal to -1 then duplicates exist.
